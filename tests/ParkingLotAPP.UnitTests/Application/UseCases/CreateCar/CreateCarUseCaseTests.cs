    ...
    public class CreateCarUseCaseTests
    {
        ...
        public CreateCarUseCaseTests()
        {
            ...
            _useCase = new CreateCarUseCase(
                _carRepository, _carBrandRepository, _carColorRepository, _unitOfWork);
        }
        ...
        public async Task Handle_ShouldCreateCar()
        {
            ...
            _carRepository.GetByIdWithModelAndColor(Arg.Any<Guid>(), Arg.Any<CancellationToken>())
                .Returns(callInfo =>
                {
                    var car = new Car("Corolla", 2024, 2025, carBrandId, carColorId, "ABC1234");
                    return car;
                });

            var input = new CreateCarInput("Corolla", 2024, 2025, carBrandId, carColorId, "ABC1234");
            input.Plate = "ABC1234";
